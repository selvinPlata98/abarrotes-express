import {
  ...
  __publicField,
  __toCommonJS
} from "./chunk-AOA7FQ75.js";

// node_modules/preline/src/utils/index.ts
var stringToBoolean, getClassProperty, getClassPropertyAlt, isIOS, isIpadOS, isEnoughSpace, isFormElement, isParentOrElementHidden, debounce, dispatch, afterTransition, htmlToElement, classToClassList, menuSearchHistory;
...
var HSOverlay = class _HSOverlay extends HSBasePlugin {
  constructor(el, options, events) {
    ...
    this.animationTarget = ((_a = this == null ? void 0 : this.overlay) == null ? void 0 : _a.querySelector(".hs-overlay-animation-target")) || this.overlay;
    if (this.overlay)
      this.init();
  }
  init() {
...
var HSSelect = class _HSSelect extends HSBasePlugin {
  ...
  buildOption(title, val, disabled = false, selected = false, options, index = "1") {
    let template = null;
  ...
  buildOriginalOption(title, val, disabled, selected, options) {

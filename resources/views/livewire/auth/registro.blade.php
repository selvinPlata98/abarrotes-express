       ...
       <h2 class="text-2xl font-semibold mb-4 flex items-center justify-center">Registro</h2>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input wire:model="password" type="password" id="register-password" class="w-full px-3 py-1 border focus:border-transparent rounded-full focus:outline-none focus:ring-2 focus:ring-primary" title="escriba 6 de letra" minlength="8" maxlength="18" required>
                        </div>

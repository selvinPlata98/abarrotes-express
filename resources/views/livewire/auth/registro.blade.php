    ...
    <div class="flex justify-center items-center h-screen">
       ...
       <h2 class="text-2xl font-semibold mb-4">Registro</h2>
                    ...
                    <div class="mb-3">
                        ...
                        <button type="submit" class="bg-primary text-red border border-primary hover:bg-transparent hover:text-primary py-2 px-3 rounded-full w-full">Register</button>
                    </form>
          </div>
  </div>      
</div>
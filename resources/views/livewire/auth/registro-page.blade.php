<div>
    <div
        style="background-image: url('imagen/Fondo2-n4hFGeXP0-transformed.jpeg'); background-size: cover; background-position: center;">
                ...
                <form method="post" wire:submit.prevent="guardar">
                    ...
                    <div class="mb-3">
                        ...
                        <input wire:model="email" type="email" id="login-email"
                               class="w-full px-3 py-1 border focus:border-cyan-500 rounded-full focus:outline-none focus:ring-2 focus:ring-cyan-500"
                    ...
                    <button type="submit"
                            ...
                            style="background-color: #008b8b; border-color: #008b8b; transition: background-color 0.3s ease; color: white;"

...
<section id="brands" class="bg-white py-16 px-4">
 ...
 <div class="flex flex-wrap -mx-4">
  ...
  <a href="#" class="text-lg font-semibold mb-2">{{$categorias->nombre}}</a>
    ...
    @empty
        <p>No se encontraron ninguna categorías disponible.</p>
    @endforelse
...
@endif
        ...
        @empty
        <p>No se encontraron ninguna marca.</p>
    @endforelse
      ...
      <div class="relative items-center w-full px-5 py-12 mx-auto md:px-12 lg:px-24 max-w-7xl">
          <div class="grid w-full grid-cols-1 gap-6 mx-auto lg:grid-cols-3">
              ...
              <h1 class="mb-4 text-2xl font-semibold leading-none tracking-tighter text-gray-dark lg:text-3xl">Compra 100% segura.</h1>
                  ...
                  <img class="object-cover object-center w-full mb-8 rounded-xl tamanoCard" src="/imagen/segurida.png" alt="blog">
              ...
              <div class="flex flex-col p-6 bg-white rounded-xl shadow-lg">
                  ...
                  <img class="object-cover object-center w-full mb-8 rounded-xl tamanoCard"   src="imagen/tarjeta.png" alt="blog">
              </div>
              <div class="flex flex-col p-6 bg-white rounded-xl shadow-lg">
                  ...
                  <img  style="width: 150%; height: 150%;"  src="imagen/envioo.png" alt="blog">

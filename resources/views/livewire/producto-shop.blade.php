<div>
    ...
    <div class="relative">
        ...
        <option value=""></option>    
        <option value="caro">Orden precio mas alto</option>
            <option value="barato">Orden precio mas barato</option>
        </select>
    ...
    <div class="bg-white p-3 rounded-lg shadow-lg">
            ...
            <button class="bg-primary border border-transparent hover:bg-transparent hover:border-primary text-white hover:text-primary font-semibold py-2 px-4 rounded-full w-full">añadir al carrito</button>
        </div>
    </div>
    @endif 
    @endforeach
    ...
    <section id="shop-category-description" class="py-8">
        <div class="container mx-auto">
            <div class="bg-white p-6 rounded-lg shadow-lg">
                <h2 class="text-2xl font-bold mb-4">Nuestra Categoria</h2>
                <p class="mb-4">

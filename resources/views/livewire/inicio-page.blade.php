<div>
            ...
            <div class="swiper-wrapper">
                <section id="brands" class="bg-white py-16 px-4">
                    <div class="container mx-auto max-w-screen-xl px-4 testimonials">
                        ...
                        <!-- Cambio en productos -->
                        <div
                            class="flex flex-wrap -mx-4 @if($productos->where('disponible', true)->count() < 4) justify-center @endif">
                                        ...
                                        <div class="w-full sm:w-1/2 md:w-1/3 lg:w-1/3 xl:w-1/4 px-4 mb-8">
                                            <div class="bg-white p-3 rounded-lg shadow-lg text-center">
                                                ...
                                                <a href="{{ route('producto', ['id' => $producto->id]) }}"
                                                   class="text-lg font-semibold mb-2 hover:text-cyan-500 hover:underline">{{$producto->nombre}}</a>
                                                <div class="flex items-center mb-4">
                                                   <span class="text-lg font-bold text-primary">L.
    {{$producto->precio - ($producto->precio * ($producto->porcentaje_oferta / 100))}}
                                                ...
                                                <button wire:click.prevent="agregarCarrito({{$producto->id}})"
                                                    ...
                                                    <span wire:loading
                                                          wire:target="agregarCarrito({{$producto->id}})">Añadiendo...</span>
                                                </button>
                                            </div>
                                        </div>
                                    @else
                                        <div class="w-full sm:w-1/2 md:w-1/3 lg:w-1/3 xl:w-1/4 px-4 mb-8">
                                            <div class="bg-white p-3 rounded-lg shadow-lg text-center">
                                                ...
                                                <div class="flex items-center mb-4">
                                                    <span
                                                        class="text-lg font-bold text-primary">L. {{$producto->precio }}</span>
                                                </div>
                                                <button wire:click.prevent="agregarCarrito({{$producto->id}})"
                                                        class="bg-primary text-white border border-primary hover:bg-transparent hover:text-primary py-2 px-3 rounded-full w-full">
                                                    <span wire:loading.remove
                    ...
                    <section id="brands" class="bg-white py-16 px-4">
                        <div class="container mx-auto max-w-screen-xl px-4 testimonials">
                            <div class="text-center mb-12 lg:mb-20">
                                ...
                                <p class="my-7">Descubre las principales categorías que ofrecemos en nuestra tienda y
                                        ...
                                        <div class="w-full sm:w-1/2 md:w-1/4 lg:w-1/4 xl:w-1/4 px-4 mb-8">
                                            <div class="bg-white p-3 rounded-lg shadow-lg">
                                                ...
                                                <a href="{{ route('productos', ['categoria' => $categoria->id]) }}"
                                                   class="text-lg font-semibold mb-2 hover:text-cyan-500 hover:underline text-centre">{{$categoria->nombre}}</a>
                                            </div>
                    ...
                    <section id="brands" class="bg-white py-16 px-4">
                        <div class="container mx-auto max-w-screen-xl px-4 testimonials">
                            <div class="text-center mb-12 lg:mb-20">
                                <h2 class="text-5xl font-bold mb-4">Descubra <span
                                        class="text-primary">Nuestras Marcas</span></h2>
                                <p class="my-7">Explora las principales marcas que presentamos en nuestra tienda</p>
                            </div>
                            <div class="flex flex-wrap -mx-4 bg-gray-100 p-4">
                                        ...
                                        <div class="w-full sm:w-1/2 md:w-1/4 lg:w-1/4 xl:w-1/3 px-4 mb-8">
                                            <div class="bg-white p-3 rounded-lg shadow-lg">
                                                ...
                                                <img src="{{ url('storage' , $marca->imagen) }}"
                                                     class="w-full object-cover mb-4 rounded-lg tamanoCard"
                                                     alt="{{$marca->imagen}}">
                                                <a href="{{ route('productos', ['categoria' => $marca->id]) }}"
                                                   class="text-lg font-semibold mb-2 hover:text-cyan-500 hover:underline">{{$marca -> nombre}}</a>
                                            </div>
                                        </div>
                                    @endif
                                @empty
                        ...
                        <div class="relative items-center w-full px-5 py-12 mx-auto md:px-12 lg:px-24 max-w-7xl">
                            <div class="grid w-full grid-cols-1 gap-6 mx-auto lg:grid-cols-3">
                                <div class="flex flex-col p-6 bg-white rounded-xl shadow-lg">
                                    ...
                                    <p class="flex-grow text-base font-medium leading-relaxed text-gray-txt">Compra con
                                        confianza en abarrotes-express, tu tienda en línea donde garantizamos una
                                        experiencia satifatoria</p>
                                    <img class="w-full object-cover mb-4 rounded-lg tamanoCard2"
                                ...
                                <div class="flex flex-col p-6 bg-white rounded-xl shadow-lg">
                                    <h1 class="mb-4 text-2xl font-semibold leading-none tracking-tighter text-gray-dark lg:text-3xl text-center">
                                        Metodo de pago</h1>
                                    <p class="flex-grow text-base font-medium leading-relaxed text-gray-txt">Aceptamos
                                        pagos únicamente con tarjeta de crédito o débito! Puedes realizar tus compras de
                                ...
                                <div class="flex flex-col p-6 bg-white rounded-xl shadow-lg">
                                    ...
                                    <p class="flex-grow text-base font-medium leading-relaxed text-gray-txt">Coordina la
                                        entrega de tu compra directamente con el vendedor. Tienes la opción de recibirlo
                                        cómodamente en tu domicilio, en la oficina o elegir recogerlo personalmente. ¡Tú
                                        tienes la libertad de decidir lo que más te convenga!.</p>
                                    <img class="w-full object-cover mb-4 rounded-lg tamanoCard2" src="imagen/envio.svg"
                                         alt="blog">
